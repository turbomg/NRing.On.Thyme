...
public class PackageGridView extends VerticalLayout implements View {
 ...
 //   private GridCellFilter filter;
    ...
    public PackageGridView(BookingPackageItemRepository bookingPackageItemRepository) {
    ...
    public Grid<BookingPackageItem> buildPackageItemGrid() {
        ...
        Grid<BookingPackageItem> packageItemGrid = new Grid<>(BookingPackageItem.class);
...
//        });
    ...
    public VerticalLayout buildPackageGrid() {
        ...
        addPackageItemBtn.addClickListener(e -> {
           UI.getCurrent().getNavigator().navigateTo(BookingPackageItemForm.VIEW_NAME);
        });
